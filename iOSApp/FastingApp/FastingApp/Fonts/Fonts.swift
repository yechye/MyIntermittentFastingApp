...
extension Text {
    ...
    func timerDisplay() -> some View {
        modifier(ScaledFontModifier(size: platformSize(iOS: 48, macOS: 56), weight: .bold, design: .rounded))
    }
    ...
    func labelSmall() -> some View {
        modifier(ScaledFontModifier(size: platformSize(iOS: 12, macOS: 13), weight: .semibold))
    }
